    ...
    <div class="limiter">
        ...
        <div class="container-login100">
          <div class="wrap-login100">
            <form   class="login100-form validate-form" method="POST" action="password.php">
              ...
              <div class="wrap-input100 validate-input" data-validate="repeat password">
                ...
                <input class="input100" type="password" name="repeatpassword1"  placeholder=" repeat Password">
                <span class="focus-input100" > <i style='font-size:24px' class='fas'>	&#xf09c;</i> </span>
              ...
              <?php
                                if(isset($_GET['erreur'])){
                                                ...
                                                if($err==1){ 
                                                        ...
                                                        echo "<p style='color:red'>les deux mots de passe doivent être identiques</p>";
