      ...
      <div class="limiter">
        ...
        <div class="container-login100">
          <div class="wrap-login100">
            <form   class="login100-form validate-form" method="POST" action="insertion.php">
              ...
              <div class="wrap-input100 validate-input">
                <input class="input100" type="text" name="ecole" placeholder="école">
              ...
              <div class="wrap-input100 validate-input" data-validate="Enter password">
                ...
                <input class="input100" type="password" name="repeatpassword"  placeholder="Répéter Mot de Passe">
              ...
              <div class="container-login100-form-btn">
                <input type="submit"  name="submit" value="Valider"class="login100-form-btn">
