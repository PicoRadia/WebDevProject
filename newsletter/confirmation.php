...
<body>
    ...
    <div class="intro-container wow fadeIn">
      <h1 class="mb-4 pb-0">Votre inscription à notre<br><span>Newsletter</span> a bien été prise en compte</h1>
      <p class="mb-4 pb-0">Merci de vous être inscrit(e) à notre Newsletter.</p>
      </div>
  </section>
  <footer id="footer">
